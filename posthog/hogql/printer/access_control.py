...
def build_access_control_guard(
    ...
    # Count is the number of inaccessible objects excluded by the predicate, not the number of rows
    # dropped from this result — filtering is pushed into SQL, so the DB never returns the filtered rows.
